...
export const TodoItem = ({ title, date, id, index }) => {
  ...
  function deleteHandler() {
    dispatch(todosActions.deleteHandler(id));
  }
  function toggleModalHandler() {
    dispatch(todosActions.openModalHandler(id));
  }

  return (
    <>
      <ListItem state={todos.todos[index].completed}>
        <p>{title}</p>
